...
export interface RequestProps {
    ...
    body?: Object | null,
    actionName: "Cadastrar" | "Atualizar" | "Deletar" | "Operar" | "Exportar" | "Importar" | "Listar" | "Solicitar" | "Aprovar" | "Reprovar" | "Obter";
...
export interface TableOption {
    ...
    */
    ...
    type: "create" | "update" | "delete" | "view" | "export" | "approve" | "approveDiscount" | "terminate" | "show" | "hide" | "upload" | "observation";
    optionDatacy: string;
...
export interface ButtonActionProps {
    ...
    datacy: string;
    buttonType: 'button-search' | 'button-clear' | 'button-add' | 'button-reject' | 'button-confirm' | 'button-dashboard' | 'button-report' | "button-clear-dashboard";
}
...
export interface ModalSearchProps<T> {
    ...
    validateElement?: (element: T) => OptionValidation<true> | OptionValidation<false>;
...
export type SidebarField = SidebarInputSearchProps | SidebarSelectProps | SidebarTextInputProps | SidebarHoursMinutesInputProps | SidebarCustomCompont;
