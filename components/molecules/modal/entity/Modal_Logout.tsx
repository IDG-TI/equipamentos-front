...
export default function ModalLogout({ controller }: ModalProps) {
    ...
    return (
        <Modal
            ...
            overrideSubmit={() => handleLogout()}
            title='Deseja sair do sistema?'
            showButtonCancel={true}
            showButtonConfirm={true}
            body={
                <>
                    <img className={ModalStyle["logout-svg"]} src="animals-floating-with-balloons-animate.svg" alt="" />
                    <svg
                        className={ModalStyle["logout-icon"]}
